...
const subscribe = async()=> {
    const key=" BGARGTyoR-qx_DgvQVU25GzjodWyM54AA9Bmi1LDATFarPs69yLn8FeFETRtUg8oBa09JQc6qXpivCCD4gc9V00"
                ...
                <div className="container mx-auto min-h-screen">
                    <div className="flex flex-col items-center justify-center">
                        <div className="w-full md:w-4/12 text-center">
                            ...
                            >
                                <img
                                    src="./images/content/luffy.jpg"
                                    alt="my-profile"
                                    className="object-cover w-full h-full"
                                />
                            </div>
                            <h2 className="text-xl font-semibold mb-1">Amin Gangsar P</h2>
                    ...
                    <ul className="max-w-full md:max-w-lg mx-auto">
                        ...
                        >
                            ...
                            <button onClick={subscribe} className="hover:underline appearance-none">Subscribe</button>
                        </li>
                        <li
                            className="pb-3 mb-2 flex items-center justify-between w-full border-b border-gray-100"
                        >
